...
public class Blinkin_Test_BESA_23042024 extends LinearOpMode {
    ...
    public void runOpMode()  {
        ...
        digitalTouch1 = hardwareMap.get(TouchSensor.class, "digitalTouch1");
        // Communicating with TouchSensor1

        digitalTouch2 = hardwareMap.get(TouchSensor.class, "digitalTouch2");
        // Communicating with TouchSensor2
        ...
        // When play is pressed, run the code inside this loop
            ...
            telemetry.addData("Is TouchSensor1 Pressed?: ", digitalTouch1.isPressed());
            telemetry.addData("variableForTouch1 State: ", variableForTouch1);
            telemetry.addData("Is TouchSensor2 pressed?: ", digitalTouch2.isPressed());
